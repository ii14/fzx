...
const char *strcasechr(const char *s, char c)
{
    ...
    size_t *positions)
{
  ...
  M = static_cast<score_t (*)[1024]>(malloc(sizeof(score_t) * MATCH_MAX_LEN * n));
  D = static_cast<score_t (*)[1024]>(malloc(sizeof(score_t) * MATCH_MAX_LEN * n));
